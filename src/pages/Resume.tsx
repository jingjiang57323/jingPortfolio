...
import resumeImg from "./asset/resume/Resume.png";
...
export default function Resume() {
  ...
  return (
    <div >
      ...
      <img className="resumeBg" style={{width: "620px", height: "800px", border: "5px solid rgba(249, 221, 197, 1)"}} src={resumeImg} alt="resume" />
    </div>
  );
}
