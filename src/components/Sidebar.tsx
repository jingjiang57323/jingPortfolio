...
import insIcon from "./sidebar/ins.png";
import fbIcon from "./sidebar/fb.png";
import linkedinIcon from "./sidebar/linkedin.png";
import twitterIcon from "./sidebar/twitter.png";
